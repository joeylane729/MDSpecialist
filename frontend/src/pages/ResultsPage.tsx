      ...
      <div className="container mx-auto px-4 pb-8">
        ...
        <div className="flex justify-between items-center mb-4 py-4 border-b border-gray-200">
          <div className="flex items-center space-x-4">
            ...
            {/* LangChain AI Recommendations Button */}
            <button
              onClick={() => navigate('/langchain-results', { 
                state: { 
                  searchParams: searchParams 
                } 
              })}
              className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-blue-700 flex items-center space-x-2 transition-all duration-200 shadow-md hover:shadow-lg"
            >
