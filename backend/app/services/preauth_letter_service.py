...
"""
            ...
            if publications and len(publications) > 0:
                ...
                # Get last name (last word in the name) and capitalize it properly
                last_name_raw = provider_name.split()[-1] if provider_name.split() else provider_name
                last_name = last_name_raw.capitalize()  # Converts "SCHWARTZ" to "Schwartz"
