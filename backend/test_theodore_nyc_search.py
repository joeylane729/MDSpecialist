#!/usr/bin/env python3
"""
Test search for Theodore Schwartz MD New York neurological surgery.
"""
...
def search_theodore_schwartz_nyc():
    """Search for Theodore Schwartz MD New York neurological surgery."""
    
    print("🔍 Searching for: theodore schwartz md new york neurological surgery")
    print("=" * 80)
    ...
    # Search query
    query = "theodore schwartz md new york neurological surgery"
