#!/usr/bin/env python3
"""
Test search for Theodore Schwartz MD medical school with full metadata.
"""
...
def search_theodore_schwartz():
    """Search for Theodore Schwartz MD medical school."""
    
    print("🔍 Searching for: Theodore Schwartz MD medical school")
    print("=" * 70)
    ...
    # Search query
    query = "Theodore Schwartz MD medical school"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if items:
                ...
                # Print the full JSON for complete metadata
                print(f"\n🗂️  FULL JSON RESPONSE:")
                print("-" * 30)
